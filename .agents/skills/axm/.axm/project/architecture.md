...
- **SKILL.md 的 YAML frontmatter 只含 name + description**：遵循 Anthropic Agent Skills 开放标准
- **description 覆盖三大场景关键词**：初始化 `.axm`、校验 axm-meta、同步 index；"稍微 pushy" 抵抗 AI 的 undertrigger 倾向
