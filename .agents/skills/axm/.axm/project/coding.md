...
## axm metadata 解析（scripts/_lib/frontmatter.mjs）
...
- 一律遵循 `.axm/universal/docs.md` 的三套 axm-meta 骨架
- 每份文档回答**一个**问题
- 结构化优先：表格 / 列表 / 代码块
...
**特别提醒**：`scripts/_lib/frontmatter.mjs` 的任何改动都要用多份 `.axm/` 文档实际回归（本仓库的 `.axm/` 就是回归套件）。
