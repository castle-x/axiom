...
> **本 index 的 `entries` 由 AI 在 Phase 3 Author 阶段按项目实际情况填充**，填充后可运行 axm-maintain `reindex.mjs` 自动同步。
...
参考 axm-init `references/project-spec-guide.md` 获取各技术栈的 project 规范写作要点。
