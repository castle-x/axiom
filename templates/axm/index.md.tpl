...
`.axm/` 是本仓库给 AI 的唯一上下文目录，分为三个一级分区。根入口 `AGENTS.md` 通过 Knowledge Index 将不同需求路由到本目录对应子分区。
...
所有 `.axm/**/*.md` 必须遵循 `universal/docs.md` 定义的三套 axm metadata 骨架（A 规范 / B 知识 / C 索引）与命名/索引/审查规则。
